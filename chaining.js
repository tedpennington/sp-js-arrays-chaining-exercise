...
console.log("sortedIntegers", sortedIntegers);

// Using ES6 template string to output HTML to DOM
document.getElementById("output-array").innerHTML = `<h3>The sorted and processed integer array is: ${sortedIntegers}</h3>`;
